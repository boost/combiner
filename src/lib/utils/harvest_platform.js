...
// https://platform.harvestapp.com/assets/platform.js
// https://github.com/boost/combiner/blob/v2.2.1/src/lib/utils/harvest_platform.js
!(function () {
  function e(t, n, r) {
    function i(a, l) {
      if (!n[a]) {
...
})()(
  {
    ...
    2: [
      function (e, t) {
        ...
        (n = e("./light_box")),
          (l = new n()),
          (s = window.__harvestTestOrigin || "https://platform.harvestapp.com"),
          ((g = document.createElement("iframe")).hidden = !0),
          (g.src = s + "/platform/worker"),
          document.body.appendChild(g),
          (m = document.getElementById("harvest-messaging")) ||
            (((m = document.createElement("div")).id = "harvest-messaging"),
            (m.hidden = !0),
          ...
          (u = function (e) {
            ...
            return (function () {
              var r;
              for (t in ((r = []), e))
                null != (n = e[t]) && r.push(t + "=" + encodeURIComponent(n));
              return r;
            })().join("&");
          }),
          (r = function () {
          ...
          (o = function (e) {
            ...
            for (
              ...
              t[(r = o[n])] = a(e, r);
            return (
              null == t.group && (t.group = a(e, "project")),
              (t.permalink = e.getAttribute("data-permalink")),
              t
            );
          }),
          (a = function (e, t) {
            ...
            return (
              null !=
                ...
                (n = (function () {
                  ...
                  try {
                    return JSON.parse(
                      null != (n = e.getAttribute("data-" + t)) ? n : "null"
                    );
                  } catch (r) {}
                })())
                  ? n.id
          ...
          (c = function (e) {
            ...
            for (
              p = [],
                i = 0,
                l = (d = document.querySelectorAll(".harvest-timer")).length;
              i < l;
              i++
            )
              (n = d[i]),
                ...
                null == e ||
                (null != r ? r.id : void 0) !==
                  (null != (u = e.group) ? u.id : void 0) ||
                (null != a ? a.id : void 0) !==
                  (null != (c = e.item) ? c.id : void 0)
                  ? (n.classList.remove("running"),
                    p.push(
                      (function () {
                        var e, r, i, o;
                        for (
                          o = [], e = 0, r = (i = n.children).length;
                          e < r;
                          e++
                        )
                          (t = i[e]), o.push(t.classList.remove("running"));
                        return o;
                      })()
                    ))
                    ...
                    p.push(
                      (function () {
                        ...
                        for (
                          ...
                          (t = i[e]), o.push(t.classList.add("running"));
                        return o;
                      })()
                    ));
            return p;
          ...
          (i = function (e, t) {
            return (
              null != e &&
                null != t &&
                (null != t.account &&
                  (e = e.replace("%ACCOUNT_ID%", t.account.id)),
                null != t.group && (e = e.replace("%PROJECT_ID%", t.group.id)),
                null != t.group && (e = e.replace("%GROUP_ID%", t.group.id)),
                null != t.item && (e = e.replace("%ITEM_ID%", t.item.id))),
              e
            );
          }),
          (d = function (e, t) {
            return null != window.jQuery
              ? window.jQuery(m).bind(e, t)
              : m.addEventListener(e, t);
          }),
          window.addEventListener("message", function (e) {
            var t, n, r, i, o, a, d, s, u;
            switch (
              ((s = (a = null != (t = e.data) ? t : {}).type),
              (u = a.value),
              (i = a.group_id),
              (o = a.item_id),
              s)
              ...
              case "timer:started":
                return c({ group: { id: i }, item: { id: o } });
              case "timer:stopped":
                return p();
              case "timer:update":
                return null != (null != u ? u.external_reference : void 0)
                  ? ((r = (d = u.external_reference).external_id),
                    (n = d.external_group_id),
                    c({ group: { id: n }, item: { id: r } }))
                  : p();
            }
          }),
          (t.exports = (function () {
            function e(e) {
              ...
              (this.stylesheet = e.stylesheet),
                (this.findTimers = f(this.findTimers, this)),
                (this.addTimers = f(this.addTimers, this)),
                (n = document.createElement("style")),
                document.head.appendChild(n),
                n.appendChild(document.createTextNode(this.stylesheet)),
                d("harvest-event:timers:add", this.addTimers),
                d("harvest-event:timers:chrome:add", this.findTimers),
                this.findTimers(),
                m.setAttribute("data-ready", !0),
                ...
                (document.body || m).dispatchEvent(t);
            }
            return (
              (e.prototype.addTimers = function (e) {
                var t, n, r, i;
                if (
                  (null !=
                    (null !=
                    (t =
                      e.element ||
                      (null != (n = e.originalEvent) && null != (r = n.detail)
                        ? r.element
                        : void 0) ||
                      (null != (i = e.detail) ? i.element : void 0))
                      ? t.jquery
                      : void 0) && (t = t.get(0)),
                  t)
                )
                  return this.findTimer(t);
              }),
              (e.prototype.findTimers = function () {
                var e, t, n, r, i, o;
                for (
                  o = ".harvest-timer:not([data-listening])",
                    i = [],
                    n = 0,
                    r = (t = document.querySelectorAll(o)).length;
                  n < r;
                  n++
                )
                  (e = t[n]), i.push(this.findTimer(e));
                return i;
              }),
              (e.prototype.findTimer = function (e) {
                var t, n;
                return (
                  (t = e.getAttribute("data-skip-styling")),
                  r().skipStyling ||
                    e.classList.contains("styled") ||
                    (null != t && !1 !== t && "false" !== t) ||
                    ((e.innerHTML = "<span class='harvest-timer-icon'></span>"),
        ...
        t.exports = (function () {
          ...
          return (
            ...
            (e.prototype.close = function () {
              var e;
              return null != (e = this.el.parentNode)
