      ...
      <section className="story_details">
        <section className="story_header grid-x">
          ...
          <fieldset className="name cell auto">
            <TextareaAutosize
              rows="1"
              className="story-name-textarea"
              defaultValue={story.name}
            />
          </fieldset>
          <a
            href={buildStoryUrl(story)}
            type="button"
            className="open-story"
            title="Switch to a full page view of this story"
          ></a>
        </section>
          ...
          <section className="controls">
            <div className="small button-group">
              <button
                ...
                title="Copy this story's link to your clipboard"
              >
                <FontAwesomeIcon icon="link" />
              </button>
              <HarvestButton className="button harvest-timer" data={story}>
                <FontAwesomeIcon icon="clock" />
              </HarvestButton>
              <button
                className="button"
                onClick={this.handleCopyIdClick}
                title="Copy this story's ID to your clipboard"
              >
                ID
              </button>
              <button
            ...
            <div className="grid-x grid-margin-x">
              <div className="medium-6 cell info_box_wrapper">
                <div className="grid-x row">
                  ...
                  <button
                    className="button tiny cell shrink"
                    value={stateAction}
              ...
              <div className="medium-6 cell info_box_wrapper">
                ...
                <div className="grid-x row">
                  ...
                  <select
                    className="cell shrink"
                    value={this.state.story.estimate}
