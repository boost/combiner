...
class StoryDetailsEdit extends Component {
  ...
  async componentDidMount() {
    const story = await enrichStory(this.props.client, this.props.story, [
      "tasks",
      "blockers",
      "owners",
      "requester",
    ...
    const projectLabels = await this.props.client.projectLabels(
      this.props.story.project_id
    );
    const memberships = await this.props.client.projectMemberships(
      this.props.story.project_id
    );
